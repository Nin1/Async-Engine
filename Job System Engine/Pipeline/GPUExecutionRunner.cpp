...
void GPUExecutionRunner::RunJobInner(JobCounterPtr& jobCounter)
{
	...
	Jobs::CreateJobAndCount(GPUExecutionRunner::MainThreadTasks, this, JOBFLAG_MAINTHREAD, jobCounter);

	m_framesCompleted++;
}

DEFINE_CLASS_JOB(GPUExecutionRunner, MainThreadTasks)
{
	/*************
	* PRE-RENDER *
	*************/
